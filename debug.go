...
// set to the specific event that triggered the hook. Lua identifies
...
// Lua is simulating a return from a function that did a tail call;
// in this case, it is useless to call Getinfo.
//
// While Lua is running a hook, it disables other calls to
// hooks. Therefore, if a hook calls back Lua to execute a function or
